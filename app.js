      ...
      slotEl.innerHTML = `
        ...
        <div class="mv-slot-header" onclick="event.stopPropagation()">
          ...
          <div class="mv-slot-controls">
            ...
            <button class="mv-control-btn" onclick="fullscreenMultiviewSlot(${i})" title="Fullscreen">
            ...
            <button class="mv-control-btn close-btn" onclick="clearMultiviewSlot(${i})" title="Close Stream">
